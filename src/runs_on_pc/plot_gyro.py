...
# Gyro
axs[0].plot((imu_df['time_micros'] - imu_df['time_micros'].iloc[0]) / 1e6, imu_df['gyro_x'], label='Gyro X')
axs[0].plot((imu_df['time_micros'] - imu_df['time_micros'].iloc[0]) / 1e6, imu_df['gyro_y'], label='Gyro Y')
axs[0].plot((imu_df['time_micros'] - imu_df['time_micros'].iloc[0]) / 1e6, imu_df['gyro_z'], label='Gyro Z')
...
axs[1].plot((imu_df['time_micros'] - imu_df['time_micros'].iloc[0]) / 1e6, imu_df['rotation_x'], label='Rotation X')
axs[1].plot((imu_df['time_micros'] - imu_df['time_micros'].iloc[0]) / 1e6, imu_df['rotation_y'], label='Rotation Y')
axs[1].plot((imu_df['time_micros'] - imu_df['time_micros'].iloc[0]) / 1e6, imu_df['rotation_z'], label='Rotation Z')
